...
<head>
  ...
  <link rel="stylesheet" href='<c:url value="/css/chatroom.css" />'>
...
<body>
  ...
  <div class="wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-3 participants">
          <div class="participants-title">In room: <span></span></div>
          <div class="participants-list mCustomScrollbar" data-mcs-theme="minimal-dark">
          	<div></div>
          </div>
        </div>
        <div class="col-xs-6 dialog">
          <div class="name">
            <p>
              <a href='<c:url value="/projects/${room.project.id}" />'>${room.project.name}:</a> ${room.name}
            </p>
          </div>
